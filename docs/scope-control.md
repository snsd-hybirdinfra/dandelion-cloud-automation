...
| Ansible | playbook 실행 |
| 서비스 | Docker 설치 |
| 서비스 | Custom WordPress 및 MariaDB 컨테이너 실행 |
...
| 구분 | 선택 확장 내용 |
|---|---|
| 보안 | HAProxy Reverse Proxy 기반 HTTPS 적용 |
...
| 구분 | 목표 완료일 | 기준 |
|---|---|---|
| A급 필수 구현 | 2026-06-26 | OpenStack, SSH, Ansible, Docker/WordPress, Health Check, Backup/Restore, 필수 캡처 완료 |
...
## B+ Stretch Goal: OpenStack CLI + Ansible End-to-End Automation

B급 선택 확장이 조기에 완료될 경우, 추가 확장 목표로 OpenStack CLI와 Ansible을 결합한 End-to-End 자동 구축을 시도한다.
